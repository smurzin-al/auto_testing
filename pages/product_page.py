...
class ProductPage(BasePage):
    ...
    def compare_product_price(self):
        info_message_product_price = self.browser.find_element(*ProductPageLocators.INFO_MESSAGE_PRODUCT_PRICE_VALUE).text
        product_price = self.browser.find_element(*ProductPageLocators.PRODUCT_PRICE_VALUE).text
